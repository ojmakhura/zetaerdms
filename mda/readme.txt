    ...
    The project located in this directory has been generated by Onalenna Makhura
    ...
    that a model called 'zetaedrms' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /zetaedrms J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Onalenna Makhura/.m2/repository/zetaedrms/
